...
# Vercel functions run on a read-only deployment filesystem. Prefer a hosted
# database through DATABASE_URL (e.g. Neon/PostgreSQL). For a local/demo
# fallback on Vercel, use /tmp so the function can still write temporarily.
...
if database_url:
    ...
    if os.environ.get("VERCEL"):
        database_url = "sqlite:////tmp/teamorbit.db"
    else:
        database_url = "sqlite:///teamorbit.db"
