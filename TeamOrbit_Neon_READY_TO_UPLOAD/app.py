...
# Use the hosted Neon/PostgreSQL database on Vercel so user, team,
# project and task data persists across serverless requests.
# Locally, fall back to the existing SQLite database.
database_url = (
...
if database_url:
    # SQLAlchemy + psycopg driver format.
